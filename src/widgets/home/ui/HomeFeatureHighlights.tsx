...
export function HomeFeatureHighlights() {
  return (
    <section className="py-16">
      <div className="mb-10">
        <p className="text-sm uppercase tracking-[0.3em] text-primary font-semibold mb-3">Features</p>
        <h2 className="text-3xl font-bold">퍼블이 사랑받는 이유</h2>
      </div>

      <div className="grid gap-6 md:grid-cols-2">
        {featureCards.map((feature) => (
          <div key={feature.title} className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm">
